...
const CURATED = [
  ...
  },
  {
    ...
    line: "A credit building platform that parses real bank statements as CSV, PDF or image, redacts PII before analysis, and turns the result into the next step that actually moves a score.",
  ...
  },
  {
    ...
    tags: ["React", "Firebase", "Behavioural design"],
  },
  {
    key: "remiband",
    from: "flagship",
...
export const featuredWork = CURATED.map((item) => {
  ...
  const RANK = { "Case study": 0, Live: 1, "Live Demo": 1, "View Code": 2 };
  const trimmed = links
    .slice()
