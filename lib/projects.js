...
export const flagships = [
...

  {
    slug: "wealthbridge",
    name: "WealthBridge",
    kicker: "Agentic financial guidance",
    category: "FinTech · Financial education · Agentic AI",
    ...
    summary:
      "A financial education platform built around an AI advisor that helps people understand their money, set goals and take a next step, with Credit Repair, Smart Investing and Mentorship modules on a real-time Firebase backend.",
    problem:
      "Financial education aimed at underserved communities is usually generic, static and dull. It rarely adapts to the person reading it, and almost never tells them what to actually do next.",
    solution:
      "A full-stack platform whose 'Wealth Navigator' agent uses designed prompt flows, tool calls and reasoning chains to give guidance grounded in the user's own situation. BrightPocket extends it into statement parsing and automated categorisation.",
    capabilities: [
...
export const moreWork = [
  ...
  },
  {
    ...
    status: "deployed",
    links: [
      { label: "Live", href: "https://bloom-aba.web.app" },
  ...
  {
    name: "EDITH Intelligence",
    blurb: "A multi-agent system for proactive organisational intelligence across Slack. Memory, insight, recommendation, action and analytics agents work together to surface what a team has not realised it needs yet. The independent evolution of EDITH.",
    status: "design",
    links: [],
  },
  {
