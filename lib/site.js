...
export const experience = [
  ...
  },
  {
    ...
    points: [
      ...
      "Ran AI-driven qualitative analysis on Azure Cognitive Services, cutting cloud spend by roughly $13,000 a month.",
      "Built an ML model on Boston housing market data to optimize ROI, and wrote the IT knowledge base for post-deployment support.",
    ],
  },
];
...
export const credentials = {
  /*
   * Two degrees as of September 2026, so this is a list rather than a single
   * set of fields. Most recent first, which is the order a reviewer reads
   * education in. The bachelor's is finished; the master's is in progress and
   * is labelled as such, because "anticipated" is the one word that stops an
   * in-progress degree from reading as a completed one.
   */
  education: [
    {
      degree: "M.S. Computer Science",
      school: "West Virginia State University",
      detail: "In progress · Anticipated May 2028",
    },
    {
